...
struct Flag {
    ...
    constexpr inline operator int() const noexcept { return int(this->i); }
    constexpr inline operator long() const noexcept { return this->i; }
    constexpr inline operator long long() const noexcept { return this->i; }
...
struct Flags {
    ...
    constexpr inline operator int64_t() const noexcept { return this->i; }
    constexpr inline operator uint64_t() const noexcept { return this->i; }
    ...
    constexpr inline bool operator!() const noexcept { return !this->i; }
...
protected:
    ...
    constexpr static inline int64_t initializerListHelper(
        ...
        return (it == end ? 0
            : (int64_t(*it) | Flags::initializerListHelper(it + 1, end)));
    }
    int64_t i;
};
template<typename E>
