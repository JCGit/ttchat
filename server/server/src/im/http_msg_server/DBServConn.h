...
private:
	...
	void _HandlePkGroupResp(CImPdu* pPdu);
	void _HandlePkGroupChangeRsp(CImPdu* pPdu);
	void _HandlePkGroupPlaceReq(CImPdu* pPdu);
	void _HandlePkGroupPlaceRsp(CImPdu* pPdu);
private:
	bool 		m_bOpen;
	uint32_t	m_serv_idx;
};
