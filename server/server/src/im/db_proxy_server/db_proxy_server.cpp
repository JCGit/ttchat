...
namespace
{
static void ToggleLogLevel(int signum) noexcept
{
    auto const l = Logger::getLogger().toggleLogLevel();
    Fatal(__func__ << l)
}
}
int main(int argc, char* argv[])
{
    Logger::setDefaultLogger("log/.log");
    Logger::getLogger().setOutputs(Logger::Output::CoutOrCerr);
    Logger::getLogger().setLogLevel(LogLevel::Erro);
