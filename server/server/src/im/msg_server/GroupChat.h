...
public:
	...
	void HandlePK10GroupRuleRequest(CImPdu* pPdu, CMsgConn* pFromConn);
	void HandlePK10GroupRuleBroadcast(CImPdu* pPdu);

	void HandlePK10PlaceRequest(CImPdu* pPdu, CMsgConn* pFromConn);
	...
	void HandleGroupPK10PlaceResponse(CImPdu* pPdu);
private:
